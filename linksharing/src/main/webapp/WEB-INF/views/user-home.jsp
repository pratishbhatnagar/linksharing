...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap-theme.css">
		...
		<nav class="navbar">
            <div class="container" style="border:1px solid grey; border-radius:10px;">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <form class="navbar-form navbar-right" style="border:1px solid grey; border-radius:15px;">
                    ...
                    <div class="col-md-1">
                        <div class="dropdown">
                            <a class="btn dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>${userDTO.firstName}
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="row panel panel-default">
                        <div class="col-md-4">
                            <img src="#" class="img img-thumbnail img-responsive" alt="Image" id="uimg" style="width:75px;height:75px">
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="#"><span class="glyphicon glyphicon-envelope" style="font-size:20px"></span></a>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 panel">
                                        ...
                                        <div class="panel-footer">
                                            <a href="#"><span class="fa fa-facebook-square" style="font-size:20px; color:blue"></span></a>
                                            <a href="#"><span class="fa fa-tumblr" style="font-size:20px"></span></a>
                                            <a href="#"><span class="fa fa-google-plus" style="font-size:20px; color:red"></span></a>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="dropdown">
                                                    <!-- <button class="btn dropdown-toggle" type="button" data-toggle="dropdown" name="visibility"><span class="glyphicon glyphicon-user"></span>Public
                                                      <span class="caret"></span></button> -->
                                                      <!-- <ul class="dropdown-menu" id="visibility" name="visibility">
                                                        <li>Public</li>
                                                        <li>Private</li>
                                                      </ul>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="dropdown">
                                                    <button class="btn dropdown-toggle" type="button" data-toggle="dropdown" id="topic"><span class="glyphicon glyphicon-user"></span>Topic
                                                      <span class="caret"></span></button>
                                                      <ul class="dropdown-menu">
                                                        <li><a href="#">...</a></li>
                                                        <li><a href="#">...</a></li>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="dropdown">
                                                    <button class="btn dropdown-toggle" type="button" data-toggle="dropdown" id="docTopic"><span class="glyphicon glyphicon-user"></span>Topic
                                                      <span class="caret"></span></button>
                                                      <ul class="dropdown-menu">
                                                        <li><a href="#">...</a></li>
                                                        <li><a href="#">...</a></li>
