...
<title>Link Sharing | Login</title>
<link
...
<body>
	...
	<div class="container"
		...
		<form class="navbar-form navbar-right"
			style="border: 1px solid grey; border-radius: 15px; margin: 5px">
											...
											<div class="col-md-9 panel">
												...
												<div class="panel-footer">
													<a href="http://facebook.com" target="_blank"><span
														...
														style="font-size: 20px; color: red"></span></a> <a href="#"
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div class="pull-right">
								<!-- <div class="dropdown pull right">
									<button class="dropdown-toggle btn-responsive"
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-9 panel">
									<span class="text-primary">Uday Pratap Singh</span> <span
										class="text-muted">@uday 21 jul 2014</span> <span
										class="text-primary pull-right">Grails</span>
									<div class="panel-body text-justify">Lorem ipsum dolor
										sit amet, consectetur adipiscing elit, sed do eiusmod tempor
										incididunt ut labore et dolore magna aliqua. Ut enim ad minim
										veniam, quis nostrud exercitation ullamco laboris nisi ut
										aliquip ex ea commodo consequat. Duis</div>
									<div class="panel-footer">
										<a href="http://facebook.com" target="_blank"><span
											class="fa fa-facebook-square"
											style="font-size: 20px; color: blue"></span></a> <a
											...
											class="fa fa-tumblr" style="font-size: 20px"></span></a> <a
											href="http://plus.google.com" target="_blank"><span
											class="fa fa-google-plus" style="font-size: 20px; color: red"></span></a>
